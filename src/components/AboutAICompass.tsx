  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
      ...
      <Card className="lg:col-span-3">
        <SectionTitle icon={<Mail className="h-5 w-5 text-blue-600 dark:text-blue-400" />} title="Contact Us" />
        <p>
          Have questions, feedback, or ideas for collaboration? Email us at{" "}
          <a className="font-medium text-blue-600 dark:text-blue-400 underline hover:text-blue-700 dark:hover:text-blue-300" href="mailto:ai-compass@sanofi.com">
